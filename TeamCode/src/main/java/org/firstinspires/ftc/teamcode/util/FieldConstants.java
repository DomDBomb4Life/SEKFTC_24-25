...
public class FieldConstants {
    ...
    public static final Pose2d LEFT_START = new Pose2d(31,60.8 , Math.toRadians(270));
    public static final Pose2d RIGHT_START = new Pose2d(-8,60.8, Math.toRadians(270));
    ...
    public static final Pose2d SPECIMEN_SCORING_POSITION_LEFT = new Pose2d(6.9,38.3 , Math.toRadians(270));
    // Sample positions
    public static final Pose2d[] SAMPLE_POSITIONS = {
            new Pose2d(47.8, 46.9, Math.toRadians(270)),
            new Pose2d(56.8, 46.9, Math.toRadians(270)),
            new Pose2d(51.057, 39.635, Math.toRadians(295))
    };
}
